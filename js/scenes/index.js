...
export const SelectScene = {
    ...
    draw(ctx) {
        ...
        this._drawCharPanel(ctx, marisaX, panelY, panelW, panelH, 'marisa', marisa.selectName, this.selectedIndex === 1, marisa.selectAccentColor);
...
export const BattleScene = {
    ...
    _spawnPickup() {
        ...
        if (spawnOnGround) {
            ...
            y = GROUND_Y - 32; // Just above ground
        } else {
    ...
    _drawHPBar(ctx, fighter, x, y, isLeft) {
        ...
        const nameColor = character.accentColor;
    ...
    _drawSkillUI(ctx, fighter, x, y, isPlayer) {
        ...
        const colors = getCharacterDefinition(fighter.name).skillColors;
